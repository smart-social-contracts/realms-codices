...
assigned_random = quarter_codex.assign_quarter("principal_test_123", quarters, "")
...
orig_strategy = quarter_codex.ASSIGNMENT_STRATEGY
quarter_codex.ASSIGNMENT_STRATEGY = "least_populated"
assigned_lp = quarter_codex.assign_quarter("principal_test_456", quarters, "")
...
quarter_codex.ASSIGNMENT_STRATEGY = "user_choice"
assigned_uc = quarter_codex.assign_quarter("principal_test_789", quarters, "ccccc-cc")
assert assigned_uc == "ccccc-cc", "Should honour user choice"
print("User choice assignment: " + assigned_uc)

# Restore original strategy
quarter_codex.ASSIGNMENT_STRATEGY = orig_strategy
