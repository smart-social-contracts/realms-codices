...
- Name: agora.spec.ts >> Agora codex E2E (staging) >> A2 — public dashboard (logged out) incumbent profile
- Location: specs/agora.spec.ts:49:3
...
Locator: getByRole('heading', { name: /ManualTest8Agora/i })
Expected: visible
Timeout: 90000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /ManualTest8Agora/i })
