...
- Name: agora.spec.ts >> Agora codex E2E (staging) >> U2 — admin via II bypass + test-mode invite
- Location: specs/agora.spec.ts:103:3
...
Locator: getByText(/Realm Settings|alpha/i).first()
Expected: visible
Timeout: 90000ms
...
Call log:
  ...
  - waiting for getByText(/Realm Settings|alpha/i).first()
