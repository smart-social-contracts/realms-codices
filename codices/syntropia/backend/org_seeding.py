...
profiles, Position seats (headcount + salary line), extension access grants
(``extensions``), sidebar hide rules (``hidden_extensions``), and one
multi-use invite code per position so civil servants can be onboarded with a
URL and appointed to their seat on redemption (issues #241/#244).
