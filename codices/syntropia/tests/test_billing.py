...
warn_result = billing_mod.warn_user(user_bob.id, str(inv_result_bob.get("invoice_id", "")))
...
kick_result = billing_mod.kick_user(user_carol.id, "test_invoice")
